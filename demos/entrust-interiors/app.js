const demoData = {
  accounts: [
    {
      ...
      useCase: "full-home turnkey interiors for a premium apartment",
      competitor: "local boutique + contractor combo",
      risk: "quote comparison and material-cost concern",
      summary: "Whitefield 4BHK family is close to signing, but they are comparing Entrust's full-home quote against a cheaper semi-turnkey alternative.",
      nextStep: "Walk them through BOQ differences and material lock-in confidence",
    },
    {
      id: "ACC-002",
      ...
      useCase: "villa interiors execution with premium materials and phased approvals",
      competitor: "none",
      risk: "timeline pressure and client anxiety about delivery sequencing",
      summary: "Sarjapur villa project is signed and under construction, with the client closely watching timeline, material approvals, and execution quality.",
      nextStep: "Send milestone update and reassure on delivery sequencing",
    },
    {
      id: "ACC-003",
      ...
      useCase: "villament interiors with remote decision-making support",
      competitor: "Livspace",
      risk: "trust, remote coordination, and render-to-reality concern",
      summary: "NRI buyer has started discussions for a villament project and wants confidence that Entrust can manage approvals and execution with minimal supervision.",
      nextStep: "Share remote execution process and sample weekly update format",
    },
  ],
  opportunities: [
    {
      id: "OPP-101",
      accountId: "ACC-001",
      name: "Prestige Lakeside Habitat 4BHK full-home interiors",
      amount: "INR 38L",
      decisionCriteria: "BOQ clarity, material quality, single-point accountability",
      winProbability: "72%",
    },
    {
      id: "OPP-102",
      accountId: "ACC-002",
      name: "Adarsh Palm Retreat villa turnkey interiors",
      amount: "INR 47L",
      decisionCriteria: "timeline reliability, finish quality, proactive updates",
      winProbability: "100%",
    },
    {
      id: "OPP-103",
      accountId: "ACC-003",
      name: "Birla Alokya villament interiors proposal",
      amount: "INR 29L",
      decisionCriteria: "remote execution trust, design fit, communication discipline",
      winProbability: "38%",
    },
  ],
  calls: [
    {
      ...
      accountId: "ACC-001",
      date: "2026-03-18",
      summary: "Project Cedar buyers liked the design direction but asked why the quote sits above two other Whitefield vendors.",
      painPoints: "quote comparison without like-for-like BOQ parity",
      objections: "price, boq, materials",
      nextStep: "Share BOQ comparison and explain what's included",
    },
    {
      id: "CALL-002",
      accountId: "ACC-001",
      date: "2026-03-28",
      summary: "Client asked whether a lower-cost laminate and hardware combination could reduce the quote without affecting the final look too much.",
      painPoints: "cost pressure on BOQ line items",
      objections: "material cost, value engineering",
      nextStep: "Offer calibrated value-engineering options",
    },
    {
      id: "CALL-003",
      accountId: "ACC-002",
      date: "2026-03-22",
      summary: "Project Elan client approved most core materials but is worried that handover could slip because civil corrections are still open.",
      painPoints: "timeline anxiety during execution",
      objections: "timeline, coordination",
      nextStep: "Send revised milestone chart",
    },
    {
      id: "CALL-004",
      accountId: "ACC-002",
      date: "2026-03-31",
      summary: "Villa client asked who is personally accountable if imported finish material arrives late and whether alternates will be approved before use.",
      painPoints: "execution trust and substitution fear",
      objections: "trust, materials, timeline",
      nextStep: "Reassure on material lock-in and escalation path",
    },
    {
      id: "CALL-005",
      accountId: "ACC-003",
      date: "2026-03-20",
      summary: "Project Mira buyer asked how Entrust handles remote approvals for drawings, materials, and site-stage updates.",
      painPoints: "remote execution visibility",
      objections: "remote execution, trust",
      nextStep: "Share remote approval workflow and sample update cadence",
    },
  ],
  objections: [
    {
      ...
      text: "Why is your quote higher than the other two firms we spoke to for this 4BHK?",
      strategy: "Explain the BOQ in a like-for-like way, show what is included in turnkey scope, and anchor on quality control plus named accountability.",
      resolution: "open",
    },
    {
      id: "OBJ-002",
      ...
      text: "Can we reduce the cost by swapping a few materials without changing the overall feel too much?",
      strategy: "Offer value-engineering options clearly separated into safe substitutions and design-risk substitutions.",
      resolution: "open",
    },
    {
      id: "OBJ-003",
      ...
      text: "If civil corrections delay one part of the site, how do you prevent the whole villa handover timeline from slipping?",
      strategy: "Show milestone sequencing, dependencies, and how Entrust escalates risks early rather than waiting for the client to ask.",
      resolution: "open",
    },
    {
      id: "OBJ-004",
      ...
      text: "Who is actually responsible if materials are delayed or if the final site quality does not match what was approved?",
      strategy: "Lead with named accountability, material approval protocol, and documented escalation paths.",
      resolution: "open",
    },
    {
      id: "OBJ-005",
      ...
      text: "We are not in Bengaluru full-time. How will we approve materials and stay confident during execution?",
      strategy: "Explain remote approvals, weekly updates, photo/video documentation, and milestone-based communication.",
  ...
  assets: [
    {
      id: "MSG-001",
      topic: "pricing",
      title: "Quote and BOQ value narrative",
      message: "Never defend price in the abstract. Walk the client through scope, material specification, execution quality, and what Entrust is accountable for from design to handover.",
      proofPoints: [
        "Like-for-like comparison matters more than headline quote value",
        "Premium buyers pay for reduced uncertainty, not just materials",
        "Single-point accountability protects both quality and timeline",
      ],
    },
    {
      id: "MSG-002",
      topic: "materials",
      title: "Material lock-in reassurance",
      message: "Use material lock-in, sample approval, and stage-wise documentation as the core reassurance when clients worry the final space may not match the design intent.",
      proofPoints: [
        "Physical or documented sample approvals reduce mismatch risk",
        "Substitutions should never be silent",
        "Photo documentation protects trust during execution",
      ],
    },
    {
      id: "MSG-003",
      topic: "timeline",
      title: "Timeline confidence framing",
      message: "Do not promise perfect certainty. Show milestone clarity, dependency management, and proactive communication when timelines face pressure.",
      proofPoints: [
    ...
    },
    {
      ...
      message: "Entrust should sound like a boutique firm with design intelligence and real execution ownership. Named accountability is the trust bridge between beautiful design and reliable delivery.",
      proofPoints: [
  ...
  funnelEvents: [
    { accountId: "ACC-001", date: "2026-03-28", move: "quote shared -> pre-closing", reason: "Client shortlisted Entrust but wants BOQ and material clarity" },
    ...
    { accountId: "ACC-003", date: "2026-03-20", move: "lead generated -> initial discussions", reason: "NRI buyer entered structured discovery with Entrust" },
  ],
  battlecards: [
    {
      competitor: "Livspace",
      talkTrack: "Differentiate Entrust on design specificity, named accountability, and boutique execution discipline rather than platform scale.",
    },
    {
      competitor: "local boutique + contractor combo",
      talkTrack: "Differentiate Entrust on structured process, BOQ clarity, quality control, and proactive communication across execution.",
    },
  ],
  scenarios: [
    {
      title: "Quote objection",
      description: "Client says Entrust's quote is higher than another 4BHK interior quote.",
      prompt: "How should I handle the pricing and BOQ objection for Project Cedar?",
    },
    {
      title: "Timeline anxiety",
      description: "Villa client is nervous that site delays may impact handover.",
      prompt: "Give me a response for Project Elan on the delivery timeline concern.",
    },
    {
      title: "NRI reassurance",
      description: "Remote buyer needs confidence in approvals and weekly visibility.",
      prompt: "How do I reassure Project Mira about remote execution and updates?",
    },
    {
      title: "Materials concern",
      description: "Client wants to know if the final materials will match the approved design.",
      prompt: "What should I say when a client worries the final materials may not match the renders?",
    },
  ],
};
...
function initialize() {
  ...
  addMessage(
    ...
    "System",
    [
      "<p>This local MVP uses dummy sales memory to simulate the Entrust premium interiors copilot workflow.</p>",
      "<p>Use it as a structural prototype for quote, materials, trust, and timeline objections.</p>",
...
function renderStats() {
  const stats = [
    ["Interiors projects", demoData.accounts.length, () => openProjectsPanel("all")],
    ...
    ["Typical value band", "INR 20L-50L", openValueBandPanel],
  ];
...
function renderProjectBriefs() {
  ...
  featuredAccountIds.forEach((accountId) => {
    ...
    card.innerHTML = `
      ...
      <p><strong>Project type:</strong> ${escapeHtml(account.useCase)}</p>
      ...
      <p><strong>Interiors project:</strong> ${escapeHtml(opportunity ? `${opportunity.name} • ${opportunity.amount}` : "Not linked")}</p>
    `;
...
function openProjectsPanel(filterStage) {
  ...
  let title = "All Interiors Projects";
  let summary = "Every dummy project in the sandbox with its current stage, amount, latest call, and next step.";
...
function openCallsPanel() {
  ...
  openDetailPanel({
    ...
    summary: "Recent dummy call notes across the entire interiors pipeline.",
    itemsHtml,
  });
}
...
function openValueBandPanel() {
  const itemsHtml = `
    <article class="detail-item">
      ...
      <p><strong>What this means:</strong> The sandbox is designed around Entrust's core business band for premium apartment, villament, and villa interiors.</p>
      <p><strong>Used across the dataset:</strong> Open leads, live proposals, pre-closing deals, under-construction projects, and completed handovers all stay within this range.</p>
    </article>
  `;
...
function answerQuestion(question) {
  ...
  if (!account) {
    return `<p>I could not confidently match that to one of the seeded dummy interiors projects. Try the exact project name, development name, or pick a project from the dashboard first.</p>`;
  }
...
function detectType(normalized) {
  if (normalized.includes("timeline") || normalized.includes("handover") || normalized.includes("delivery")) {
    return "timeline";
  }
  ...
  if (normalized.includes("price") || normalized.includes("pricing") || normalized.includes("quote") || normalized.includes("boq")) {
    return "pricing";
  }
  if (normalized.includes("material") || normalized.includes("render") || normalized.includes("finish")) {
    return "materials";
  }
  return "general";
}
...
function selectObjections(accountId, normalized) {
  ...
  if (normalized.includes("price") || normalized.includes("pricing") || normalized.includes("quote") || normalized.includes("boq")) {
    return all.filter((item) => item.category === "price_quote" || item.category === "boq_scope" || item.category === "material_cost");
  }
  if (normalized.includes("material") || normalized.includes("render") || normalized.includes("finish")) {
    return all.filter((item) => item.category === "material_cost" || item.category === "quality_execution");
  }
  if (normalized.includes("remote") || normalized.includes("nri")) {
...
function selectAssets(type, normalized) {
  ...
  if (type === "pricing") {
    return demoData.assets.filter((item) => item.topic === "pricing" || item.topic === "boq" || item.topic === "materials");
  }
  if (type === "trust") {
    return demoData.assets.filter((item) => item.topic === "trust" || item.topic === "adoption");
  }
  if (type === "materials") {
    return demoData.assets.filter((item) => item.topic === "materials");
  }
  if (type === "remote") {
...
function buildDirectAnswer(type, account, opportunity, objections, assets) {
  if (type === "timeline") {
    return `For ${account.name}, handle the timeline concern with milestone clarity, dependency visibility, and proactive communication. Do not promise zero risk; show how Entrust manages and communicates it.`;
  }

  if (type === "remote") {
    return `For ${account.name}, reassure the client through process: remote approvals, weekly updates, visual documentation, and named accountability from design through handover.`;
  }
  ...
  if (type === "pricing") {
    return `For ${account.name}, do not defend the quote in the abstract. Reframe the conversation around scope clarity, material specification, execution quality, and what Entrust is taking responsibility for from design through handover.`;
  }

  if (type === "materials") {
    return `For ${account.name}, reassure the client by showing how Entrust locks materials, documents approvals, and prevents silent substitutions during execution.`;
  }
...
function buildTalkTrack(type, account, objections, assets, battlecard) {
  if (type === "timeline") {
    return "We would rather be specific than casually optimistic. The way we manage timelines is through milestone sequencing, early flagging of dependencies, and proactive updates before you have to ask. If something on site affects the schedule, we will show you the impact and the recovery path clearly.";
  }

  if (type === "remote") {
    return "You do not need to be on site every week for the project to stay controlled. We structure remote approvals, share visual progress updates on a defined cadence, and keep one named owner accountable for decisions and escalations. The point is not just remote convenience, but remote confidence.";
  }
  ...
  if (type === "materials") {
    return "The way we protect the final outcome is by not treating materials casually. Key selections are locked, approvals are documented, and if an alternate is ever needed it is discussed explicitly before execution. That is how we reduce the gap between what you approved and what you finally see on site.";
  }

  const objection = objections[0];
  const asset = assets[0];
  const competitorLine = battlecard ? `${battlecard.talkTrack} ` : "";
  return `The real question behind "${objection ? objection.text : "this objection"}" is whether the quote feels justified for the outcome and accountability being promised. ${asset ? asset.message : "Lead with the approved value narrative."} ${competitorLine}I would anchor first on like-for-like scope, material quality, and delivery confidence rather than trying to win the conversation on price alone.`;
}
...
function buildNextStep(type, account, opportunity) {
  if (type === "timeline") {
    return "Send the client a milestone-wise update with the current dependency, expected impact, and the action Entrust is taking to hold the schedule.";
  }
  if (type === "remote") {
    return "Share one real sample of the weekly update rhythm so the client can see exactly how remote approvals and progress communication will work.";
  }
  if (type === "trust") {
...
function seedInteriorPortfolioVolume(store) {
  ...
  const stageBlueprint = {
    "lead generated": {
      ...
      category: "price_quote",
      objection: "What is a realistic budget for a premium interiors project in this size range?",
      strategy: "Anchor the conversation in project size, finish level, and scope rather than vague market averages.",
      callSummary: "Lead entered the system through referral and is trying to understand realistic budget and scope for a premium interiors project.",
      painPoints: "budget uncertainty and scope confusion",
      nextStep: "Qualify possession date and budget range",
    },
    "initial discussions": {
      previousStage: "lead generated",
      category: "trust_accountability",
      objection: "Who will stay accountable after the sales stage if we move ahead?",
      strategy: "Lead with named ownership, communication cadence, and what partner visibility looks like after sign-off.",
      callSummary: "Client is in early discovery and is testing whether Entrust feels trustworthy, thoughtful, and responsive enough to continue.",
    ...
    "site visit scheduled": {
      ...
      category: "design_fit",
      objection: "How quickly will we see a concept after the site visit, and will it reflect how we actually live?",
      strategy: "Set a clear concept turnaround and explain the structured brief process used during the visit.",
      callSummary: "Buyer agreed to a site visit and now wants confidence that Entrust will understand the family’s daily routines and aesthetic direction.",
      painPoints: "speed and design understanding",
      nextStep: "Run site visit and capture structured brief",
    },
    "concept presentation": {
      previousStage: "site visit scheduled",
      category: "quality_execution",
      objection: "How do we know the finished home will match what is being shown here?",
      strategy: "Use material approvals, mockups where needed, and stage-wise documentation to connect concept to execution.",
      callSummary: "Concept has landed well, and the buyer is now testing how safely Entrust can carry the design intent into reality.",
      painPoints: "render-to-reality confidence",
      nextStep: "Refine concept and align it to budget",
    },
    "quote shared": {
      previousStage: "concept presentation",
      category: "boq_scope",
      objection: "Why is this BOQ more detailed and more expensive than another vendor quote?",
      strategy: "Use the BOQ as proof of transparency, scope clarity, and reduced risk rather than only as a price sheet.",
      callSummary: "The buyer has the first formal quote in hand and is now comparing inclusions, exclusions, and line-item depth across vendors.",
      painPoints: "line-item comparison and quote shock",
      nextStep: "Walk client through the BOQ line by line",
    },
    "pre-closing": {
      previousStage: "quote shared",
      category: "change_orders",
      objection: "How will payment milestones and change orders be handled once we sign?",
      strategy: "Show commercial clarity, milestone evidence, and formal change-order discipline before asking for closure.",
      callSummary: "Client prefers Entrust overall and is now working through the final commercial and trust questions before signing.",
      painPoints: "final commercial comfort",
      nextStep: "Close scope, payment schedule, and start date",
    },
    "under construction": {
      previousStage: "pre-closing",
      category: "timeline_delivery",
      objection: "How are you managing timeline risk now that the site is live?",
      strategy: "Use milestone updates, dependency communication, and proactive issue flagging to maintain trust.",
      callSummary: "Project is active on site and the client is focused on timeline clarity, quality checks, and execution accountability.",
      painPoints: "site coordination and timeline confidence",
      nextStep: "Send milestone update and next approval checklist",
    },
    "handover completed": {
      previousStage: "under construction",
      category: "post_handover_support",
      objection: "What support do we get after handover if small issues appear?",
      strategy: "Frame snagging and post-handover support as part of the premium service promise, not an afterthought.",
      callSummary: "Project is complete and the conversation has shifted to snagging, aftercare, and referral readiness.",
      painPoints: "aftercare and retention",
      nextStep: "Complete post-handover check-in and referral ask",
    },
  };
  ...
  const unitTypes = ["3BHK", "3.5BHK", "4BHK", "Villa", "Villament"];
  ...
  const decisionCriteriaMap = {
    "lead generated": "budget fit, scope clarity, premium positioning",
    "initial discussions": "trust, responsiveness, design fit",
    "site visit scheduled": "consultation quality, brief depth, speed",
    "concept presentation": "design confidence, practicality, quality assurance",
    "quote shared": "BOQ clarity, payment comfort, value engineering",
    "pre-closing": "commercial clarity, accountability, schedule confidence",
    "under construction": "timeline visibility, quality control, client communication",
    "handover completed": "aftercare, snagging response, referral confidence",
  };
  ...
  stages.forEach((stage, stageIndex) => {
    ...
    for (let i = 0; i < needed; i += 1) {
      ...
      store.accounts.push({
        ...
        stage,
        opportunityId,
        useCase: `${unitType} premium interiors in ${locality}`,
        competitor,
      ...
      store.opportunities.push({
        id: opportunityId,
        accountId,
        name: `${development} • ${unitType} interiors`,
        amount,
